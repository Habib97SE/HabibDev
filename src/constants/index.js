...
const socialLinks = [
    {
        ...
        icon: github,
        description:
            "My GitHub profile, you can see my projects and contributions.",
    },
    {
        id: 2,
        title: "LinkedIn",
        ...
        icon: linkedin,
        description:
            "My LinkedIn profile, you can see my professional background and experiences.",
    },
    {
        id: 3,
        title: "X (Twitter)",
...
const services = [
    {
        ...
        icon: web,
        description:
            "I can build scalable and responsive web applications using modern web technologies like React.js, Next.js, and Tailwind CSS.",
    },
    {
        title: "iOS Developer",
        icon: mobile,
        description:
            "I can develop native iOS applications using Swift and SwiftUI, and also integrate with backend services.",
    },
    {
        title: "Backend Developer",
        icon: backend,
        description:
            "I can develop scalable and efficient backend services using Node.js, Express.js, and Spring boot.",
    },
    {
        title: "Java Developer",
        icon: creator,
        description:
            "I can develop Java applications using Spring Boot, and also integrate with backend services.",
    },
];
...
const projects = [
    {
        name: "Chapter Chaser",
        description:
            "Chapter Chaser is a SwiftUI-based iOS app designed to help book enthusiasts discover, organize, and track their reading. You can search for books, add them to your library, and track your reading progress. The app also provides personalized recommendations based on your reading history.",
        tags: [
            {
                name: "swift",
    ...
    },
    {
        name: "JKPG City",
        description:
            "A web application that helps users discover the best places to visit in Jönköping, Sweden. Users can explore the city's attractions, restaurants, and events, all in one place. The app also provides a map view to help users navigate the city easily.",
        tags: [
            {
                name: "react.js",
                color: "text-blue-500",
    ...
    },
    {
        name: "Diet Monitor",
        description:
            "Diet Monitor is a mobile app and website that helps users track their daily food intake and monitor their nutritional goals. Users can set daily calorie limits and track their progress over time. The app also provides personalized recommendations based on the user's dietary preferences.",
        tags: [
            {
                name: "react.js",
                color: "text-blue-500",
    ...
    },
    {
        name: "Tic Tac Toe",
        description:
            "A simple Tic Tac Toe game built with Kotlin and Jetpack Composer. The game features online multiplayer mode, single-player mode against AI, and local multiplayer mode. The app uses Supabase as the backend service to store game data and manage user authentication.",
        tags: [
            {
                name: "Kotlin",
                color: "text-blue-500",
...
const contact = {
    ...
    declinePrivacyPolicy:
        "You have declined our privacy policy. You can't send a message without accepting it.",
